          ...
          fields: [
            {
              ...
              __vModel__: 'mobile',
              placeholder:
                '请输入手机号身份证号身份证号身份证号身份证号身份证号身份证号身份证号身份证号',
              style: {
                width: '100%',
              },
              clearable: true,
            ...
            },
            {
              __config__: {
                ...
                regList: [],
                formId: 102,
                renderKey: '1021636354505605',
              },
              __slot__: {
                prepend: '',
                append: '',
              },
              placeholder: '请输入支行机构号',
              style: {
                width: '100%',
              },
              clearable: true,
            ...
            },
            {
              __config__: {
                ...
                regList: [],
                formId: 103,
                renderKey: '1031636354669762',
              },
              __slot__: {
                prepend: '',
                append: '',
              },
              placeholder: '请输入分行机构号',
              style: {
                width: '100%',
              },
              clearable: true,
